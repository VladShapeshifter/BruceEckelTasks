...
public class TransactionsProxyHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws InvocationTargetException, IllegalAccessException {
        ...
        try {
            writerC = new FileWriter(new File("C:\\Workspace\\BruceEckelTasks\\src\\net\\mindview\\chapter14\\proxy\\CompletedOperations.txt"), true);
        } catch (IOException e) {
//            e.printStackTrace();
            System.out.println("File \'CompletedOperations\' was not found");
        }
        try {
            writerF = new FileWriter("C:\\Workspace\\BruceEckelTasks\\src\\net\\mindview\\chapter14\\proxy\\FailuredOperations.txt", true);
        } catch (IOException e) {
//            e.printStackTrace();
        ...
        try {
            ...
            if (writerF != null) {
                try {
                    writerF.write("[" + new Date(System.currentTimeMillis()) + "] : Transaction failure \n");
                    writerF.close();
